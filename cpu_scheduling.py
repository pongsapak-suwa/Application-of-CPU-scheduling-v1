...
def upload_file():
    ...
    def gantt__output():
        ...
        color = ['#E5FFCC','#FF3333','#CCE5FF','#FFAEB9','#CCFFFF','#CD8C95','#FFFF99',
        '#FFC0CB','#3D6395','#EEA9B8','#4B471C','#88DB8E','#FFE600','#FF82AB','#EE799F','#85BCA6','#8B475D','#FFF0F5','#EEE0E5',
        '#888EDB','#8B8386','#1C25A2','#EE3A8C','#CD3278','#656162','#BC1340','#2EC138','#EE6AA7','#CD6090','#8B3A62','#872657',
        '#E4D2E1','#2A3472','#722A47','#F9A3C5','#5C3004','#BF6205','#045C5C','#58E5E5','#BC31A5','#F9CEA3','#8B3A62','#FF83FA',
        '#F6FF6C','#EE1289','#FCBBCD','#8B0A50','#BBE8FC','#EE30A7','#CD2990','#8B1C62','#C71585','#D02090','#DA70D6']
        ...
        for i in range (len(finished_program)):
            if i <= 49:
                gnt.broken_barh([(finished_program[i][1], working_process[i][1])],(add_y, 5),facecolors = color[i])
            else:
